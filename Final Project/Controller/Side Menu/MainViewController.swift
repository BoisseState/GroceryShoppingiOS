...
class MainViewController: UIViewController, MenuDelegate {
    ...
    /*static let sharedInstance = MainViewController(nibName: nil, bundle: nil)
    ...
    @objc func onSlideMenuButtonPressed(_ sender : UIButton){
        ...
        menuVC.view.frame = CGRect(x: 0 - width, y: 0, width: width, height: height)
        
        UIView.animate(withDuration: 0.3, animations: { () -> Void in
            menuVC.view.frame=CGRect(x: 0, y: 0, width: width, height: height);
